...
public class SeleniumUtility {
	...
	public void setUp(String browserName,String appUrl) {
		...
		String filePath=System.getProperty("user.dir")+"\\src\\main\\resources\\testData\\testAppData.properties";
		try {
	 ...
	 */
	protected void handleHtmlDropdownListWithVisibleText(WebElement element,
			String visibileText) {
	 ...
	 * Utility to handle HTML dropdown list
	 */
	protected WebElement getFirstSelectedOptionFromHtmlDropdownList(
			WebElement element) {
	 ...
	 * Utility to handle HTML dropdown list
	 */
	protected List<WebElement> getAllSelectedOptionFromMultiSelectDropdownList(
			WebElement element) {
